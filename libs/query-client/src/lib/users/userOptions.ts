import {
  personsControllerGetFollowStatus,
  userMoviesControllerGet,
  userMoviesControllerListInfinite,
  UserMoviesControllerListInfiniteData,
  UserPlaylistsControllerListInfiniteData,
  ...
  userFollowersControllerListInfinite,
  UserFollowingControllerListInfiniteData,
  userFollowingControllerListInfinite,
  movieWatchedDatesControllerListInfinite,
  MovieWatchedDatesControllerListInfiniteData,
  Bookmark,
  bookmarksControllerGetByMedia,
  UserBookmarksControllerListAllData,
  userBookmarksControllerListAll,
  userBookmarksControllerListPaginated,
  UserBookmarksControllerListPaginatedData,
  UserPlaylistsControllerListPaginatedData,
  userPlaylistsControllerListPaginated,
  UserFollowersControllerListPaginatedData,
  UserFollowingControllerListPaginatedData,
  MovieWatchedDatesControllerListPaginatedData,
  UserMoviesControllerListPaginatedData,
  userMoviesControllerListPaginated,
  movieWatchedDatesControllerListPaginated,
  userFollowersControllerListPaginated,
  userFollowingControllerListPaginated,
  RecoTargetsControllerListPaginatedData,
  recoTargetsControllerListPaginated,
  recoTargetsControllerListInfinite,
  RecoTargetsControllerListInfiniteData,
  recoTargetsControllerListAll,
  RecoTargetsControllerListAllData,
  userFollowControllerGet,
  UserFollowRequestsControllerListPaginatedData,
  userFollowRequestsControllerListPaginated,
  UserFollowRequestsControllerListInfiniteData,
  userFollowRequestsControllerListInfinite,
  UserRecosControllerListAllData,
  userRecosControllerListAll,
  UserRecosControllerListPaginatedData,
  userRecosControllerListPaginated,
  UserRecosControllerListInfiniteData,
  userRecosControllerListInfinite,
  playlistLikesControllerGet,
  playlistSavesControllerGet,
  usersControllerGet,
  UserPlaylistsSavedControllerListInfiniteData,
  userPlaylistsSavedControllerListInfinite,
  userPlaylistsSavedControllerListPaginated,
  UserPlaylistsSavedControllerListPaginatedData,
  UsersControllerListPaginatedData,
  usersControllerListPaginated,
  UsersControllerListInfiniteData,
  usersControllerListInfinite,
  MePlaylistsFollowingControllerListPaginatedData,
  mePlaylistsFollowingControllerListPaginated,
  MePlaylistsFollowingControllerListInfiniteData,
  mePlaylistsFollowingControllerListInfinite,
  FeedPersonsControllerListInfiniteData,
  feedPersonsControllerListInfinite,
  FeedPersonsControllerListPaginatedData,
  feedPersonsControllerListPaginated,
  PlaylistsAddTargetsControllerListAllData,
  playlistsAddTargetsControllerListAll,
  PlaylistsAddTargetsControllerListPaginatedData,
  playlistsAddTargetsControllerListPaginated,
  PlaylistsAddTargetsControllerListInfiniteData,
  playlistsAddTargetsControllerListInfinite,
  userTvSeriesControllerGet,
  UserTvSeriesControllerListPaginatedData,
  userTvSeriesControllerListPaginated,
  UserTvSeriesControllerListInfiniteData,
  userTvSeriesControllerListInfinite,
  UserFeedControllerListPaginatedData,
  userFeedControllerListPaginated,
  UserFeedControllerListInfiniteData,
  userFeedControllerListInfinite,
  userPinnedControllerList,
} from '@libs/api-js';
...
export const userByIdOptions = ({ userId }: { userId?: string }) => {
  return queryOptions({
...
export const userByUsernameOptions = ({ username }: { username?: string }) => {
  return queryOptions({
...
/* ---------------------------------- Logs ---------------------------------- */
// Movie
export const userMovieLogOptions = ({ userId, movieId }: { userId?: string; movieId?: number }) => {
  return queryOptions({
...
/* --------------------------------- Pinned --------------------------------- */
export const userPinnedOptions = ({ userId }: { userId?: string }) => {
  return queryOptions({
    queryKey: userKeys.pinned({ userId: userId! }),
    queryFn: async () => {
      if (!userId) throw new Error('User ID is required');
      const { data, error } = await userPinnedControllerList({
        path: {
          user_id: userId,
        },
      });
