...
export const userKeys = {
	...
	feed: ({
		...
		| { mode: 'infinite'; filters?: Omit<NonNullable<UserFeedControllerListInfiniteData['query']>, 'cursor'> }
	)) => {
		const optionsKey = [...(mode !== undefined ? [mode] : []), ...(filters ? [filters] : [])];
