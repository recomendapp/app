...
import { UpdateFollowCountsDto, UpdatePlaylistItemsDto, UpdatePlaylistLikesDto, UpdatePlaylistSavesDto, UpdateReviewMovieLikesDto, UpdateReviewTvSeriesLikesDto } from "./counters.dto";
...
type BaseCountersRegistry = {
  ...
  'update-playlist-items': UpdatePlaylistItemsDto;
