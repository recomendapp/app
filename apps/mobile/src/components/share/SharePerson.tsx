...
export const SharePerson = forwardRef<ShareViewRef, SharePersonProps>(
  ({ person, variant = 'default', isPremium, ...props }, ref) => {
    ...
    const renderSticker = useCallback(
      (scale: number) => <SharePersonDefault person={person} poster={poster} scale={scale} />,
      [person, poster],
    );
