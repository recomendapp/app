...
interface BadgeMediaProps extends React.ComponentPropsWithoutRef<typeof Badge> {
  type?: 'movie' | 'tv_series' | 'person' | null;
}

const BadgeMedia = React.forwardRef<React.ComponentRef<typeof Badge>, BadgeMediaProps>(
