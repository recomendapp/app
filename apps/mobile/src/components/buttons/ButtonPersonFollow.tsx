...
const ButtonPersonFollow = forwardRef<React.ComponentRef<typeof Button>, ButtonPersonFollowProps>(
  ({ personId, onPress, skeleton, style, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        style={[tw.style('px-4 py-2 h-auto rounded-full'), style as ViewStyle]}
        {...props}
      >
        {isFollow
