...
type ReviewFormProps = ReviewFormBaseProps & (ReviewFormMovieProps | ReviewFormTvSeriesProps);
...
const ReviewForm = ({
  ...
  const hasChanges = useMemo(() => {
    const bodyChanged = review
      ? body !== null && body !== review.body
      : body !== null && body !== undefined && body.length > 0;
