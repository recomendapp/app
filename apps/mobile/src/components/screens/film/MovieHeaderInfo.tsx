...
export const MovieHeaderInfo = forwardRef<React.ComponentRef<typeof View>, MovieHeaderInfoProps>(
  ({ movie, style, ...props }, ref) => {
    ...
    return (
      <View
        ref={ref}
        style={[tw`flex-row flex-wrap items-center justify-center`, style]}
        {...props}
      >
