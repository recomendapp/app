        ...
        z.object({
          comment: z
            ...
            .min(commentMinLength, {
              message: upperFirst(t('common.form.length.char_min', { count: commentMinLength })),
            })
            .max(commentMaxLength, {
              message: upperFirst(t('common.form.length.char_max', { count: commentMaxLength })),
            })
            .nullable(),
        }),
    ...
    return (
      ...
      >
        ...
        {isEditing ? (
          ...
          <Pressable
            onPress={isAllowedToEdit ? () => setIsEditing(true) : undefined}
            style={{
              position: 'relative',
