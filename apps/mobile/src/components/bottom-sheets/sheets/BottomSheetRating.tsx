  ...
  ({ index, totalItems, rating, scrollX, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        <Text style={tw`text-white text-4xl font-bold`}>{rating}</Text>
      </Animated.View>
    );
  },
);
...
>(({ id, media, rating, onRatingChange, ...props }, ref) => {
  ...
  return (
    <TrueSheet ref={ref} style={{ paddingTop: PADDING_VERTICAL * 2 }} {...props}>
      <View
        style={[
        ...
        <View style={tw`flex-1 items-center justify-center`}>
          <Animated.View
            style={[
              { aspectRatio: 2 / 3 },
              tw.style(
                'relative flex gap-4 items-center w-2/5 shrink-0 rounded-sm overflow-hidden',
              ),
            ]}
          >
            <ImageWithFallback
