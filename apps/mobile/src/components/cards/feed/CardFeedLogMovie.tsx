...
interface CardFeedLogMovieBaseProps extends React.ComponentProps<typeof Animated.View> {
  variant?: 'default';
  onPress?: () => void;
  onLongPress?: () => void;
}
...
>(({ variant = 'default', onPress, onLongPress, ...props }, ref) => {
  ...
  const content = variant === 'default' ? <CardFeedLogMovieDefault ref={ref} {...props} /> : null;
...
export { CardFeedLogMovie, CardFeedLogMovieDefault };
