...
interface CardMovieBaseProps extends React.ComponentPropsWithRef<typeof Animated.View> {
...
>(
  (
    { style, movie, skeleton, activity, profile, showActionWatch, children, showRating, ...props },
    ref,
  ) => {
    ...
    return (
      ...
      >
        ...
        {!skeleton && (showActionWatch || showRating) && (
...
export { CardMovie, CardMovieDefault, CardMoviePoster };
