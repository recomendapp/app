          ...
          <View style={tw`flex-row gap-1`}>
            ...
            <Text>
              {t.rich('notifications.reco_sent_movie.description', {
                ...
                movie: () => <Text style={tw`font-semibold`}>{movie.title}</Text>,
              })}
            </Text>
          </View>
        ) : (
...
>(({ variant = 'default', ...props }, ref) => {
  ...
  const content =
    variant === 'default' ? <CardNotificationRecoSentMovieDefault ref={ref} {...props} /> : null;
...
export { CardNotificationRecoSentMovie, CardNotificationRecoSentMovieDefault };
