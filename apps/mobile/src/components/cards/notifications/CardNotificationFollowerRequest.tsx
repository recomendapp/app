...
>(({ variant = 'default', ...props }, ref) => {
  ...
  const content =
    variant === 'default' ? <CardNotificationFollowerRequestDefault ref={ref} {...props} /> : null;
  // Handler
...
export { CardNotificationFollowerRequest, CardNotificationFollowerRequestDefault };
