...
>(({ variant = 'default', ...props }, ref) => {
  ...
  const content =
    variant === 'default' ? <CardNotificationRecoSentTvSeriesDefault ref={ref} {...props} /> : null;
...
export { CardNotificationRecoSentTvSeries, CardNotificationRecoSentTvSeriesDefault };
