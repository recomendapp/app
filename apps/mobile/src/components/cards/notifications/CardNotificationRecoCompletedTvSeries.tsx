...
export type CardNotificationRecoCompletedTvSeriesProps =
  CardNotificationRecoCompletedTvSeriesBaseProps &
    (
      | CardNotificationRecoCompletedTvSeriesSkeletonProps
      | CardNotificationRecoCompletedTvSeriesDataProps
    );
    ...
    >
          ...
          <View style={tw`flex-row gap-1`}>
            ...
            <Text>
              {t.rich('notifications.reco_completed_tv_series.description', {
                ...
                tv_series: () => <Text style={tw`font-semibold`}>{tvSeries.name}</Text>,
              })}
            </Text>
          </View>
        ) : (
      ...
      {!skeleton ? (
        <ImageWithFallback
          ...
          alt={tvSeries.name ?? ''}
          type={'tv_series'}
          style={[{ aspectRatio: 9 / 16 }, tw`w-10`]}
        />
      ) : (
...
CardNotificationRecoCompletedTvSeriesDefault.displayName =
...
export { CardNotificationRecoCompletedTvSeries, CardNotificationRecoCompletedTvSeriesDefault };
