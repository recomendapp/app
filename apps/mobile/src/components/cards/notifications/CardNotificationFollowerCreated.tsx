...
>(({ variant = 'default', ...props }, ref) => {
  ...
  const content =
    variant === 'default' ? <CardNotificationFollowerCreatedDefault ref={ref} {...props} /> : null;
...
export { CardNotificationFollowerCreated, CardNotificationFollowerCreatedDefault };
