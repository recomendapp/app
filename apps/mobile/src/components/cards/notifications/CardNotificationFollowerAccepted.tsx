...
>(({ variant = 'default', ...props }, ref) => {
  ...
  const content =
    variant === 'default' ? <CardNotificationFollowerAcceptedDefault ref={ref} {...props} /> : null;
...
export { CardNotificationFollowerAccepted, CardNotificationFollowerAcceptedDefault };
