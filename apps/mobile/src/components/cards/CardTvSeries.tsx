...
interface CardTvSeriesBaseProps extends React.ComponentPropsWithRef<typeof Animated.View> {
      ...
      >
        <View style={tw`flex-1 flex-row items-center gap-2`}>
          ...
          <View style={tw`shrink px-2 py-1 gap-1`}>
            {!skeleton ? (
              <Text numberOfLines={2}>{tvSeries.name}</Text>
            ) : (
...
export { CardTvSeries, CardTvSeriesDefault, CardTvSeriesPoster };
