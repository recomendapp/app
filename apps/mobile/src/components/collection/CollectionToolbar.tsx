...
interface CollectionToolbarProps
  extends Omit<FlatListProps<CollectionToolbarItem>, 'data' | 'renderItem'> {
  view: ViewType;
...
const CollectionToolbar = forwardRef<React.ComponentRef<typeof FlashList>, CollectionToolbarProps>(
  (
    {
      view,
      onViewChange,
    ...
    const items = useMemo(
      ...
      [t, view, onViewChange, onSelectSort, sortByLabel, sortOrder, additionalToolbarItems],
    );

    const renderItem = useCallback(
      ({ item }: { item: CollectionToolbarItem }) => (
...
export type { CollectionToolbarProps, CollectionToolbarItem };
