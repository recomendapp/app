...
import { BottomSheetBookmarkComment } from '../../../../components/bottom-sheets/sheets/BottomSheetBookmarkComment';
...
const BookmarksScreen = () => {
      ...
      Alert.alert(
        ...
        upperFirst(
          richTextToPlainString(
            t.rich('pages.collection.watchlist.modal.delete_confirm.description', {
              title: title,
  ...
  const sortByOptions = useMemo(
    (): SortByOption<BookmarkWithMedia>[] => [
      {
  ...
  const swipeActions = useMemo(
    (): CollectionAction<BookmarkWithMedia>[] => [
      {
        icon: Icons.Comment,
