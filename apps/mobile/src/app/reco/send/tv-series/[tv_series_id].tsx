...
import { useUserRecosTvSeriesInsertMutation } from "apps/mobile/src/api/users/userMutations";
...
import { useUserRecosTvSeriesSendQuery } from "apps/mobile/src/api/users/userQueries";
