          ...
          <View style={{ gap: GAP }}>
            ...
            <View style={{ gap: GAP }}>
              <View style={[{ backgroundColor: colors.muted }, tw`rounded-md p-4`]}>
                <Text style={tw`text-lg font-semibold`}>{t('team.members.loup.name')}</Text>
                <Text>{t('team.members.loup.description')}</Text>
              </View>
              <View style={[{ backgroundColor: colors.muted }, tw`rounded-md p-4`]}>
                <Text style={tw`text-lg font-semibold`}>{t('team.members.yoann.name')}</Text>
          ...
          <View style={{ gap: GAP }}>
            ...
            <Text>
              {t.rich('contact-support.suggest-a-feature', {
                email: (chunks) => (
                  <Link href="mailto:ideas@recomend.app" style={{ color: colors.accentPink }}>
                    ideas@recomend.app
                  </Link>
                ),
              })}
            ...
            <Text>
              {t.rich('contact-support.contact-us', {
                email: (chunks) => (
                  <Link href="mailto:hello@recomend.app" style={{ color: colors.accentPink }}>
                    hello@recomend.app
                  </Link>
                ),
              })}
      ...
      },
      {
        content: (
          <View style={{ gap: GAP, marginTop: GAP_LG }}>
            <Icons.Quote size={40} color={colors.muted} style={tw`absolute left-0 -top-6`} />
            <Text style={tw`italic text-center`}>{t('quote.quote')}</Text>
