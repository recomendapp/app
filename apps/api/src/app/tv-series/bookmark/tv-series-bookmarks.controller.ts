...
import { BookmarkDto, BookmarkRequestDto } from '../../bookmarks/dto/bookmarks.dto';
...
export class TvSeriesBookmarksController {
  constructor(private readonly bookmarkService: TvSeriesBookmarksService) {}
