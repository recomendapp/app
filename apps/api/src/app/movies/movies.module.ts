...
import { MoviesTool } from './movies.tool';
...
@Module({
  imports: [MovieLogsModule, MoviePlaylistsModule, MovieReviewsModule, MovieImagesModule],
  controllers: [MoviesController, MoviesTool],
