...
export class PersonDto {
  ...
  @ApiProperty({
    description: 'Internal path to the person page',
  ...
  @ApiProperty({
    description: "The person's gender: 0 = Not specified, 1 = Female, 2 = Male, 3 = Non-binary",
    default: 0,
    example: 2,
    type: Number,
    nullable: true,
  ...
  @ApiProperty({ description: "The person's slug", example: '525-christopher-nolan' })
  @Expose()
  @Transform(({ obj }) => mediaSlug(obj.id, obj.name))
  @IsString()
  slug?: string;
}
