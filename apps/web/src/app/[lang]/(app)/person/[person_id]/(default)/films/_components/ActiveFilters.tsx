...
export const ActiveFilters = ({ department, job }: { department?: string; job?: string }) => {
    ...
    <ScrollArea>
      <div className="flex items-center gap-2">
        ...
        {department && (
          ...
          >
            <Icons.X />
            <span>{upperFirst(department)}</span>
        ...
        <Button
          ...
          onClick={() =>
            handleChange({ sort_by: null, sort_order: null, department: null, job: null })
          }
        >
          <Icons.X />
          <span>{upperFirst(common('messages.reset'))}</span>
        </Button>
      </div>
