...
export const Playlist = ({ playlist: playlistProps }: { playlist: PlaylistWithOwner }) => {
  ...
  return (
    <div className="h-full">
      <PlaylistHeader playlist={playlist} numberItems={playlist.itemsCount} backdrops={backdrops} />
      {items && <PlaylistTable playlist={playlist} items={items} />}
    </div>
  );
};
