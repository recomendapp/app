    ...
    >
      <Card className="w-full max-w-[400px]">
        <CardHeader className="gap-2">
          ...
          <CardDescription>{upperFirst(t('common.messages.an_error_occurred'))}</CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4">
          <Alert className="relative group">
            ...
            <ButtonCopy
              ...
              size={'sm'}
              text={error.message}
              className="absolute top-1 right-1 opacity-0 group-hover:opacity-100 duration-200 transition"
            />
          </Alert>
        </CardContent>
        <CardFooter>
