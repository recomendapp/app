...
interface BookmarksHeaderProps extends React.HTMLAttributes<HTMLDivElement> {
  skeleton?: boolean;
  numberItems: number | undefined;
  backdrops: ImageObject[];
}

export function BookmarksHeader({ numberItems, backdrops, skeleton }: BookmarksHeaderProps) {
