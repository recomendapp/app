...
interface MyRecosHeaderProps extends React.HTMLAttributes<HTMLDivElement> {
  skeleton?: boolean;
  numberItems: number | undefined;
  backdrops: ImageObject[];
}

export function MyRecosHeader({ numberItems, backdrops, skeleton }: MyRecosHeaderProps) {
