...
import { Card, CardDescription, CardHeader, CardTitle } from '@libs/ui/components/card';
import { siteConfig } from '@/config/site';
import { useTranslations } from 'next-intl';

export const WidgetRecomendShowcase = ({ className }: React.HTMLAttributes<HTMLDivElement>) => {
          ...
          <Card key={index}>
            <CardHeader>
              ...
              <CardDescription className="ml-6">
                {t(`pages.showcase.features.${feature.key}.description`)}
              </CardDescription>
            </CardHeader>
          </Card>
        ))}
