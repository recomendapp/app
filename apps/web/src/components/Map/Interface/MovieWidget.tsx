...
import { Genre } from '@libs/api-js/src';
import { cn } from '@/lib/utils';

export const MovieWidget = () => {
  const { selectedMovie, setSelectedMovie } = useMap();
          ...
          <div className="w-full h-full flex gap-2 items-center">
            ...
            <div className="flex flex-col justify-between w-full h-full">
              ...
              <div className="space-x-1">
                <Link href={`/film/${movie.id}`} className="font-bold text-lg line-clamp-2">
                  {movie.title}
                </Link>
                {/* DATE */}
                {movie.releaseDate && (
                ...
                {movie.originalTitle !== movie.title && (
                  <div className="text-xs ml-0! font-semibold text-muted-foreground line-clamp-1">
                    {movie.originalTitle}
                  </div>
                )}
              </div>
