...
interface CardUserProps extends React.ComponentProps<typeof Card> {
...
const CardUserDefault = React.forwardRef<HTMLDivElement, Omit<CardUserProps, 'variant'>>(
...
const CardUserVertical = React.forwardRef<HTMLDivElement, Omit<CardUserProps, 'variant'>>(
  ({ className, user, linked, children, ...props }, ref) => {
    return (
      <WithLink
        ref={ref}
...
const CardUserIcon = React.forwardRef<HTMLDivElement, Omit<CardUserProps, 'variant'>>(
...
const CardUserUsername = React.forwardRef<HTMLDivElement, Omit<CardUserProps, 'variant'>>(
  ({ className, user, linked, width, height, children, ...props }, ref) => {
    return (
      <WithLink
        ref={ref}
...
const CardUserInline = React.forwardRef<HTMLDivElement, Omit<CardUserProps, 'variant'>>(
...
const CardUser = React.forwardRef<HTMLDivElement, CardUserProps>(
...
export { type CardUserProps, CardUser, CardUserDefault, CardUserVertical };
