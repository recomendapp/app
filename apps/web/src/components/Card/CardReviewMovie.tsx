...
interface CardReviewMovieProps extends React.ComponentProps<typeof Card> {
  variant?: 'default';
  review: ReviewMovie;
  author: UserSummary;
  rating: number | null;
...
const CardReviewMovie = React.forwardRef<HTMLDivElement, CardReviewMovieProps>(
...
export { type CardReviewMovieProps, CardReviewMovie, CardReviewMovieDefault };
